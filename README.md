...
**Current priority: get NTO Studio working as a complete local Mac photography application.** Foundations, local photo import/Library, organisation, metadata and keyboard culling are implemented. The rendering engine, saved edit history and first exposure/contrast/saturation controls now work. The full editing toolset and user-facing export are still ahead. This is not yet Studio v0.1 or the GDD's complete CORE release.
